...
namespace mesh_comps
{
   ...
   void Mesh::FindAllHexas(int plain_size, int* well_inds, std::vector<int>** inwell_inds)
   {
      ...
      std::ofstream fhexas("Hexahedron.txt");
